...
Existing Bronze data is truncated.

AQI and weather CSV files are loaded using BULK INSERT.

Individual table load durations are recorded.

Total batch execution time is recorded.
